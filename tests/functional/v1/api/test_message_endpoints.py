...
def test_post_message_success(client, mock_get_agency, mock_firestore_client):
...
def test_post_message_agency_config_not_found(client, mock_get_agency):
    # Sending a message
...
@pytest.mark.usefixtures("mock_get_current_user")
def test_post_message_unauthorized(client, mock_get_agency, mock_firestore_client):
...
@pytest.mark.usefixtures("mock_get_current_user")
def test_post_message_processing_failure(client, mock_get_agency, mock_firestore_client):
